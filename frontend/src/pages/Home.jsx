...
getPost()
  ...
  return (
    ...
    {uploadPost && (
  <div className="w-[90%] max-w-[500px] h-[600px] bg-white shadow-lg 
      fixed top-[50%] left-[50%] -translate-x-[50%] -translate-y-[50%]
      rounded-lg z-[200] p-[20px] flex flex-col gap-[20px]"
  >
    ...
    {/* SCROLLABLE CONTENT */}
    <div className="flex-1 w-full overflow-y-auto space-y-[20px]">

      {/* Textarea */}
      <textarea
        className="w-full h-[200px] outline-none p-[10px] resize-none text-[19px]"
    ...
    <div className="w-full border-t pt-4">
      <div className="flex items-center justify-between px-2">
        ...
        {/* Image Upload Icon */}
        <BsImage
          className="w-[28px] h-[28px] text-gray-500 cursor-pointer"
          onClick={() => image.current.click()}
        />

        {/* Post Button */}
        <button
          className="w-[100px] h-[45px] rounded-full bg-[#24b2ff] text-white"
          disabled={posting}
