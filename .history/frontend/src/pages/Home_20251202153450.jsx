...
getPost()
  ...
  return (
    <div className='w-full min-h-[100vh] bg-[#f0efe7] pt-[100px] flex items-center lg:items-start justify-center gap-[20px] px-[20px] flex-col lg:flex-row relative pb-[50px]'>
      ...
      {uploadPost &&  <div className='w-[90%] max-w-[500px] h-[600px] bg-white shadow-lg top-[100px] rounded-lg fixed z-[200] p-[20px] mb-[20px] flex items-start justify-start flex-col gap-[20px]'>
         <div className='absolute top-[20px] overflow-y-auto right-[20px] cursor-pointer  '><RxCross1 className='w-[25px] cursor-pointer h-[25px] text-gray-800 font-bold ' onClick={()=>setUploadPost(false)}/></div>
